...
function createBrowserMock() {
  ...
  let updateStatus = {
    phase: 'available',
    message: '发现新版本 1.07.0',
    currentVersion: '1.07.0',
    latestVersion: '1.07.0',
  ...
  return {
    isMock: true,
    app: { info: async () => ({ version: '1.07.0', platform: 'win32', harnessVersion: '0.1.0-rc.7' }) },
    window: {
    ...
    updates: {
      ...
      download: async () => (updateStatus = { ...updateStatus, phase: 'downloaded', message: '版本 1.07.0 已通过国内社区镜像下载并通过 SHA-256 校验', progress: 100, downloadedPath: 'update.exe', downloadSource: '国内社区镜像' }),
